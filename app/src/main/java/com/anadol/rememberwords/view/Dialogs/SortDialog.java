...
import static com.anadol.rememberwords.model.SettingsPreference.getGroupOrderSort;
import static com.anadol.rememberwords.model.SettingsPreference.getGroupTypeSort;
import static com.anadol.rememberwords.model.SettingsPreference.getWordOrderSort;
import static com.anadol.rememberwords.model.SettingsPreference.getWordTypeSort;
import static com.anadol.rememberwords.presenter.ComparatorMaker.ORDER_ASC;
import static com.anadol.rememberwords.presenter.ComparatorMaker.ORDER_DESC;
import static com.anadol.rememberwords.presenter.ComparatorMaker.TYPE_DATE;
...
public class SortDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        ...
        int type = typeItems.equals(Types.GROUP.name()) ?
                getGroupTypeSort(getContext()) : getWordTypeSort(getContext());
        int order = typeItems.equals(Types.GROUP.name()) ?
                getGroupOrderSort(getContext()) : getWordOrderSort(getContext());

        typeGroup.check(type == TYPE_NAME ? R.id.name_radio : R.id.date_radio);
        orderGroup.check(order == ORDER_ASC ? R.id.asc_radio : R.id.desc_radio);
    ...
    private Intent getSetting() {
        ...
        int type = idType == R.id.date_radio ? TYPE_DATE : TYPE_NAME;

        int idOrder = orderGroup.getCheckedRadioButtonId();
        int order = idOrder == R.id.asc_radio ? ORDER_ASC : ORDER_DESC;
