...
public class MyContentProvider extends ContentProvider {
    ...
    @Nullable
    @Override
    public MyCursorWrapper query(@NonNull Uri uri, @Nullable String[] columns, @Nullable String selection, @Nullable String[] selectionArgs, @Nullable String sortOrder) {
